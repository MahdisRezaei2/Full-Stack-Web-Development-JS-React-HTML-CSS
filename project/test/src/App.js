...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <h2>Add New Event</h2>
      <div>
        <input type='text' placeholder='Add Ttile' style={{ width: '20%', marginRight: '10px' }}
          value={newEvent.title} onChange={(e) => setNewEvent({ ...newEvent, title: e.target.value })} //spread obj
        />
